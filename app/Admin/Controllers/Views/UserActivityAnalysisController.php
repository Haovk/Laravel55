...
use App\Models\Views\ViewUserActivityAnalysis;
...
class UserActivityAnalysisController extends Controller
{
    use ModelForm;
    ...
    {
        return Admin::grid(ViewUserActivityAnalysis::class, function (Grid $grid) {
    ...
    {
        return Admin::form(ViewUserActivityAnalysis::class, function (Form $form) {
