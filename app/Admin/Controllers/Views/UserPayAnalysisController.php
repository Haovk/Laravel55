...
use App\Models\Views\ViewUserPayAnalysis;
...
class UserPayAnalysisController extends Controller
{
    use ModelForm;
    ...
    {
        return Admin::grid(ViewUserPayAnalysis::class, function (Grid $grid) {
    ...
    {
        return Admin::form(ViewUserPayAnalysis::class, function (Form $form) {
