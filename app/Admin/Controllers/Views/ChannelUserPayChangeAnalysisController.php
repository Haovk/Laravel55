...
use App\Models\Views\ViewChannelUserPayChangeAnalysis;
...
class ChannelUserPayChangeAnalysisController extends Controller
{
    use ModelForm;
    ...
    {
        return Admin::grid(ViewChannelUserPayChangeAnalysis::class, function (Grid $grid) {
    ...
    {
        return Admin::form(ViewChannelUserPayChangeAnalysis::class, function (Form $form) {
