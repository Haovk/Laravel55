...
use App\Models\Views\ViewChannelUserConsumeAnalysis;
...
class ChannelUserConsumeAnalysisController extends Controller
{
    use ModelForm;
    ...
    {
        return Admin::grid(ViewChannelUserConsumeAnalysis::class, function (Grid $grid) {
    ...
    {
        return Admin::form(ViewChannelUserConsumeAnalysis::class, function (Form $form) {
