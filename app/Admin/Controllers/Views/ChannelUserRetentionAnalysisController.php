...
use App\Models\Views\ViewChannelUserRetentionAnalysis;
...
class ChannelUserRetentionAnalysisController extends Controller
{
    use ModelForm;
    ...
    {
        return Admin::grid(ViewChannelUserRetentionAnalysis::class, function (Grid $grid) {
    ...
    {
        return Admin::form(ViewChannelUserRetentionAnalysis::class, function (Form $form) {
