...
use App\Models\Views\ViewUserBalanceAnalysis;
...
class UserBalanceAnalysisController extends Controller
{
    use ModelForm;
    ...
    {
        return Admin::grid(ViewUserBalanceAnalysis::class, function (Grid $grid) {
    ...
    {
        return Admin::form(ViewUserBalanceAnalysis::class, function (Form $form) {
